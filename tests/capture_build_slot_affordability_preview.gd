...
const OUT_PATH := "/Users/zhaok/cat/artifacts/build_slot_affordability_preview.png"
...
func _capture() -> void:
	...
	if error != OK:
		push_error("failed to save build slot affordability preview screenshot: %s" % error)
		quit(1)
		return
