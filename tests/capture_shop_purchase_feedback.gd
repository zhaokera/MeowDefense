...
const OUT_PATH := "/Users/zhaok/cat/artifacts/shop_purchase_feedback.png"
const TEST_SAVE_PATH := "user://meow_defense_shop_purchase_feedback_capture_save.json"
...
func _clear_save_file() -> void:
	if FileAccess.file_exists(TEST_SAVE_PATH):
		...
		if error != OK:
			push_error("failed to clear shop purchase feedback capture save: %s" % error)
