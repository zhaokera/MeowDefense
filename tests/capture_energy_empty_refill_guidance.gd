...
const OUT_PATH := "/Users/zhaok/cat/artifacts/energy_empty_refill_guidance.png"
const TEST_SAVE_PATH := "user://meow_defense_energy_empty_refill_guidance_capture_save.json"
...
func _clear_save_file() -> void:
	if FileAccess.file_exists(TEST_SAVE_PATH):
		...
		if error != OK:
			push_error("failed to clear energy empty refill guidance capture save: %s" % error)
