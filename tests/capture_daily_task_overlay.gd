...
const OUT_PATH := "/Users/zhaok/cat/artifacts/daily_task_overlay.png"
const TEST_SAVE_PATH := "user://meow_defense_daily_task_capture_save.json"
...
func _clear_save_file() -> void:
	if FileAccess.file_exists(TEST_SAVE_PATH):
		...
		if error != OK:
			push_error("failed to clear daily task capture save: %s" % error)
