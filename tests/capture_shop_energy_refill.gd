...
const OUT_PATH := "/Users/zhaok/cat/artifacts/shop_energy_refill_purchase.png"
const TEST_SAVE_PATH := "user://meow_defense_shop_energy_refill_capture_save.json"
...
func _clear_save_file() -> void:
	if FileAccess.file_exists(TEST_SAVE_PATH):
		...
		if error != OK:
			push_error("failed to clear shop energy refill capture save: %s" % error)
