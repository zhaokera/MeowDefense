...
const OUT_PATH := "/Users/zhaok/cat/artifacts/build_slot_affordability_feedback.png"
...
func _capture() -> void:
	...
	if error != OK:
		push_error("failed to save build slot affordability feedback screenshot: %s" % error)
		quit(1)
		return
