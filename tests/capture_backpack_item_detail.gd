...
const OUT_PATH := "/Users/zhaok/cat/artifacts/backpack_item_detail.png"
const TEST_SAVE_PATH := "user://meow_defense_backpack_item_detail_capture_save.json"
...
func _clear_save_file() -> void:
	if FileAccess.file_exists(TEST_SAVE_PATH):
		...
		if error != OK:
			push_error("failed to clear backpack item detail capture save: %s" % error)
